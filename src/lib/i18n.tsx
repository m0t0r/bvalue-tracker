...
const es = {
  ...
  ingestFailedBody: "Se muestran los últimos datos guardados. Se reintenta solo cada 15 minutos hasta que el SGC vuelva a responder; no hace falta recargar.",
...
const en: Dict = {
  ...
  ingestFailedBody: "Showing the most recent stored data. It retries by itself every 15 minutes until SGC answers again; there is no need to reload.",

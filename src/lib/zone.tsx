/**
 * Which zone the page shows. It is the URL's path — `/` for Chaparral (Tolima), `/choco` — because each zone is
...
import { HOME_ZONE, ZONE_PATHS, zonePath } from "../../core/zone-pages";
import { ZONES, type Zone, type ZoneId } from "../../core/zones";
...
const Ctx = createContext<Zone>(ZONES[HOME_ZONE]);
